  ...
  return (
    <div style={{ width: "90%", margin: "auto", marginTop: "20px" }}>
      ...
      <Typography style={textStyle} my={1}>
        Bloom By Khushbu (“us”, “we”, or “our”) operates
        https://bloombykhushbu.com (the “Site”). This page informs you of our
      ...
      <Typography style={textStyle} my={1}>
        ...
        limited to your name, email id, and/or your mobile number (“Personal
        Information”).
      </Typography>
      <Typography
        style={{ ...textStyle, fontSize: 25, fontWeight: 700 }}
      ...
      <Typography style={textStyle} my={1}>
        Like most site operators, we collect information that your browser sends
        whenever you visit our Site (&ldquo;Log Data&rdquo;). This Log Data may
        include information such as your computer&apos;s Internet Protocol
        (&ldquo;IP&rdquo;) address, browser type, browser version, the pages of
        our Site that you visit, the time and date of your visit, the time spent
      ...
      <Typography style={textStyle} my={1}>
        ...
        we use &ldquo;cookies&rdquo; to collect information. You can instruct
      ...
      <Typography style={textStyle} my={1}>
        This Privacy Policy is effective as of (2nd of September 2021) and will
      ...
      <Typography style={textStyle} my={1}>
        ...
        a prominent notice on our website. This Privacy Policy is effective as
        of (1st of September 2021) and will remain in effect except with respect
        to any changes in its provisions in the future, which will be in effect
